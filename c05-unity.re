...
ここでは、Windows版を例としてhsm_aiのモデルが作られるまでを追っていきます。 VRoidStudioを起動したら、表示されたメニュー画面で新規作成を選び、作成する3Dモデルの名前を入力しモデル作成を始めます。
...
//indepimage[1][手書きガイドの修正][scale=0.8]{
//}
...
//indepimage[2][前髪のモデリング][scale=0.8]{
//}
...
//indepimage[4][hsm_aiのVRoidモデル][scale=0.8]{
//}
